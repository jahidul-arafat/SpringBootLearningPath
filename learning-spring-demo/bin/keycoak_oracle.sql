...
(
    ...
    FULL_SCOPE_ALLOWED           NUMBER(1) default 0 not null,
    CLIENT_ID                    VARCHAR2(255),
    NOT_BEFORE                   NUMBER,
    PUBLIC_CLIENT                NUMBER(1) default 0 not null,
    SECRET                       VARCHAR2(255),
    BASE_URL                     VARCHAR2(255),
    BEARER_ONLY                  NUMBER(1) default 0 not null,
    MANAGEMENT_URL               VARCHAR2(255),
    SURROGATE_AUTH_REQUIRED      NUMBER(1) default 0 not null,
    REALM_ID                     VARCHAR2(36),
    PROTOCOL                     VARCHAR2(255),
    NODE_REREG_TIMEOUT           NUMBER    default 0,
    FRONTCHANNEL_LOGOUT          NUMBER(1) default 0 not null,
    CONSENT_REQUIRED             NUMBER(1) default 0 not null,
    NAME                         NVARCHAR2(255),
    SERVICE_ACCOUNTS_ENABLED     NUMBER(1) default 0 not null,
    CLIENT_AUTHENTICATOR_TYPE    VARCHAR2(255),
    ROOT_URL                     VARCHAR2(255),
    DESCRIPTION                  NVARCHAR2(255),
    REGISTRATION_TOKEN           VARCHAR2(255),
    STANDARD_FLOW_ENABLED        NUMBER(1) default 1 not null,
    IMPLICIT_FLOW_ENABLED        NUMBER(1) default 0 not null,
    DIRECT_ACCESS_GRANTS_ENABLED NUMBER(1) default 0 not null,
    ALWAYS_DISPLAY_IN_CONSOLE    NUMBER(1) default 0 not null,
...
(
    ID          VARCHAR2(36)         not null
        primary key,
    VERSION     VARCHAR2(36),
    UPDATE_TIME NUMBER(19) default 0 not null
)
    /
...
(
    ...
    OFFLINE_FLAG         VARCHAR2(4)      not null,
    DATA                 CLOB,
    LAST_SESSION_REFRESH NUMBER default 0 not null,
...
(
    ...
    ENABLED                      NUMBER(1)    default 0 not null,
    EVENTS_ENABLED               NUMBER(1)    default 0 not null,
    EVENTS_EXPIRATION            NUMBER(19),
    ...
    REGISTRATION_ALLOWED         NUMBER(1)    default 0 not null,
    REMEMBER_ME                  NUMBER(1)    default 0 not null,
    RESET_PASSWORD_ALLOWED       NUMBER(1)    default 0 not null,
    SOCIAL                       NUMBER(1)    default 0 not null,
    SSL_REQUIRED                 VARCHAR2(255),
    SSO_IDLE_TIMEOUT             NUMBER,
    SSO_MAX_LIFESPAN             NUMBER,
    UPDATE_PROFILE_ON_SOC_LOGIN  NUMBER(1)    default 0 not null,
    VERIFY_EMAIL                 NUMBER(1)    default 0 not null,
    MASTER_ADMIN_CLIENT          VARCHAR2(36),
    LOGIN_LIFESPAN               NUMBER,
    INTERNATIONALIZATION_ENABLED NUMBER(1)    default 0 not null,
    DEFAULT_LOCALE               VARCHAR2(255),
    REG_EMAIL_AS_USERNAME        NUMBER(1)    default 0 not null,
    ADMIN_EVENTS_ENABLED         NUMBER(1)    default 0 not null,
    ADMIN_EVENTS_DETAILS_ENABLED NUMBER(1)    default 0 not null,
    EDIT_USERNAME_ALLOWED        NUMBER(1)    default 0 not null,
    ...
    REVOKE_REFRESH_TOKEN         NUMBER(1)    default 0 not null,
    ACCESS_TOKEN_LIFE_IMPLICIT   NUMBER       default 0,
    LOGIN_WITH_EMAIL_ALLOWED     NUMBER(1)    default 1 not null,
    DUPLICATE_EMAILS_ALLOWED     NUMBER(1)    default 0 not null,
    DOCKER_AUTH_FLOW             VARCHAR2(36),
    REFRESH_TOKEN_MAX_REUSE      NUMBER       default 0,
    ALLOW_USER_MANAGED_ACCESS    NUMBER(1)    default 0 not null,
...
(
    ...
    BUILT_IN    NUMBER(1)    default 0            not null
)
    /
...
(
    ...
    REQUIREMENT        NUMBER,
    PRIORITY           NUMBER,
    AUTHENTICATOR_FLOW NUMBER(1) default 0 not null,
...
(
    ...
    STORE_TOKEN                NUMBER(1) default 0 not null,
    AUTHENTICATE_BY_DEFAULT    NUMBER(1) default 0 not null,
    REALM_ID                   VARCHAR2(36)
        constraint FK2B4EBC52AE5C3B34
        references REALM,
    ADD_TOKEN_ROLE             NUMBER(1) default 1 not null,
    TRUST_EMAIL                NUMBER(1) default 0 not null,
    FIRST_BROKER_LOGIN_FLOW_ID VARCHAR2(36),
    POST_BROKER_LOGIN_FLOW_ID  VARCHAR2(36),
    PROVIDER_DISPLAY_NAME      VARCHAR2(255),
    LINK_ONLY                  NUMBER(1) default 0 not null,
...
(
    ID              VARCHAR2(36)  not null
        primary key,
    NAME            VARCHAR2(255) not null,
    IDP_ALIAS       VARCHAR2(255) not null,
...
(
    IDP_MAPPER_ID VARCHAR2(36)  not null
...
(
    ID                      VARCHAR2(36)        not null
        primary key,
    CLIENT_REALM_CONSTRAINT VARCHAR2(255),
    CLIENT_ROLE             NUMBER(1) default 0 not null,
    DESCRIPTION             NVARCHAR2(255),
    NAME                    NVARCHAR2(255),
    REALM_ID                VARCHAR2(255),
    CLIENT                  VARCHAR2(36),
...
(
    ...
    FORM_LABEL VARCHAR2(255),
    INPUT      NUMBER(1) default 0 not null,
...
(
    REQUIRED_ACTION_ID VARCHAR2(36)  not null,
    VALUE              CLOB,
    NAME               VARCHAR2(255) not null,
...
(
    ...
    REALM_ID       VARCHAR2(36)
        ...
        references REALM,
    ENABLED        NUMBER(1) default 0 not null,
    DEFAULT_ACTION NUMBER(1) default 0 not null,
    PROVIDER_ID    VARCHAR2(255),
    PRIORITY       NUMBER
)
    /
...
(
    ID                   VARCHAR2(36)          not null
        ...
        primary key,
    ALLOW_RS_REMOTE_MGMT NUMBER(1) default 0   not null,
    POLICY_ENFORCE_MODE  VARCHAR2(15)          not null,
    DECISION_STRATEGY    NUMBER(3) default '1' not null
)
    /
...
(
    ...
    DESCRIPTION        NVARCHAR2(255),
    TYPE               VARCHAR2(255) not null,
    DECISION_STRATEGY  VARCHAR2(20),
    LOGIC              VARCHAR2(20),
    RESOURCE_SERVER_ID VARCHAR2(36)  not null
...
(
    ...
    ASSOCIATED_POLICY_ID VARCHAR2(36) not null
...
(
    ...
    NAME                 VARCHAR2(255)       not null,
    TYPE                 VARCHAR2(255),
    ICON_URI             VARCHAR2(255),
    OWNER                VARCHAR2(255)       not null,
    RESOURCE_SERVER_ID   VARCHAR2(36)        not null
        constraint FK_FRSRHO213XCX4WNKOG82SSRFY
        references RESOURCE_SERVER,
    OWNER_MANAGED_ACCESS NUMBER(1) default 0 not null,
...
(
    ...
    CREATED_TIMESTAMP  NUMBER(19)    not null,
    GRANTED_TIMESTAMP  NUMBER(19),
    RESOURCE_ID        VARCHAR2(36)  not null
        constraint FK_FRSRHO213XCX4WNKOG83SSPMT
        references RESOURCE_SERVER_RESOURCE,
    SCOPE_ID           VARCHAR2(36)
...
(
    ...
    LAST_FAILURE            NUMBER(19),
    LAST_IP_FAILURE         VARCHAR2(255),
    NUM_FAILURES            NUMBER,
...
(
    ID                          VARCHAR2(36)        not null
        primary key,
    EMAIL                       VARCHAR2(255),
    EMAIL_CONSTRAINT            VARCHAR2(255),
    EMAIL_VERIFIED              NUMBER(1) default 0 not null,
    ENABLED                     NUMBER(1) default 0 not null,
    FEDERATION_LINK             VARCHAR2(255),
    FIRST_NAME                  NVARCHAR2(255),
    LAST_NAME                   NVARCHAR2(255),
    REALM_ID                    VARCHAR2(255),
    USERNAME                    NVARCHAR2(255),
    CREATED_TIMESTAMP           NUMBER(19),
    SERVICE_ACCOUNT_CLIENT_LINK VARCHAR2(255),
    NOT_BEFORE                  NUMBER    default 0 not null,
...
(
    IDENTITY_PROVIDER  VARCHAR2(255) not null,
    REALM_ID           VARCHAR2(36),
    FEDERATED_USER_ID  VARCHAR2(255),
    FEDERATED_USERNAME VARCHAR2(255),
    TOKEN              CLOB,
...
(
    USER_FEDERATION_PROVIDER_ID VARCHAR2(36)  not null
...
(
    ID                     VARCHAR2(36)  not null
        primary key,
    NAME                   VARCHAR2(255) not null,
    FEDERATION_PROVIDER_ID VARCHAR2(36)  not null
        constraint FK_FEDMAPPERPM_FEDPRV
        references USER_FEDERATION_PROVIDER,
    FEDERATION_MAPPER_TYPE VARCHAR2(255) not null,
    REALM_ID               VARCHAR2(36)  not null
...
(
    USER_FEDERATION_MAPPER_ID VARCHAR2(36)  not null

...
(
    ...
    REALM_ID                VARCHAR(36)  not null,
    STORAGE_PROVIDER_ID     VARCHAR(36),
    CREATED_DATE            NUMERIC(19),
    LAST_UPDATED_DATE       NUMERIC(19),
...
(
    ID          VARCHAR(36)      not null
        primary key,
    VERSION     VARCHAR(36),
    UPDATE_TIME NUMERIC(19) default 0 not null
);
...
(
    ...
    CLIENT_ROLE             NUMBER(1,0) DEFAULT 0 NOT NULL,
    DESCRIPTION             NVARCHAR2(255),
    NAME                    NVARCHAR2(255),
    REALM_ID                VARCHAR(255),
    CLIENT                  VARCHAR(36),
...
(
    ...
    INPUT      NUMBER(1,0) DEFAULT 0 NOT NULL,
    SECRET     NUMBER(1,0) DEFAULT 0 NOT NULL,
    REALM_ID   VARCHAR(36)           not null,
...
(
    ...
    REALM_ID       VARCHAR(36),
    ENABLED        NUMBER(1,0) DEFAULT 0 NOT NULL,
    DEFAULT_ACTION NUMBER(1,0) DEFAULT 0 NOT NULL,
    PROVIDER_ID    VARCHAR(255),
    PRIORITY       INT,
...
(
    ID                   VARCHAR(36)           not null,
    ALLOW_RS_REMOTE_MGMT NUMBER(1,0) DEFAULT 0 NOT NULL,
    POLICY_ENFORCE_MODE  VARCHAR(15)           not null,
    DECISION_STRATEGY    NUMBER(3,0) default '1'   not null,
...
(
    ...
    RESOURCE_SERVER_ID   VARCHAR(36)           not null,
    OWNER_MANAGED_ACCESS NUMBER(1,0) DEFAULT 0 NOT NULL,
...
(
    ...
    CREATED_TIMESTAMP  Numeric(19)       not null,
    GRANTED_TIMESTAMP  Numeric(19),
    RESOURCE_ID        VARCHAR(36)  not null,
    SCOPE_ID           VARCHAR(36),
    RESOURCE_SERVER_ID VARCHAR(36)  not null,

...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // means, we want to simulate a real web environment with Servlet engine running at a random port
public class ContactsManagementControllerIntegrationTest {
    // let's inject the actual controller class we want to test
    @Autowired
